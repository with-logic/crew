  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "2. For each skill, make a folder and put a `SKILL.md` inside it. The folder can have any useful source name; the `name` field in `SKILL.md` is what users install. See `crew help install` for what goes in a SKILL.md (it's the Agent Skills spec — https://agentskills.io/specification).",
