/**
 * Higher-level git operations crew uses: clone, fetch, and check out.
 * Ref resolution and classification live in `./refs.ts`, split out to
 * keep both files within the project's file-size cap.
 *
