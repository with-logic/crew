 ...
 * whether that ref names an immutable revision. A SHA or tag pins; a branch
 * tracks, so `crew update` may advance it.
 *
 * Split from `repo.ts`, which owns clone/fetch, to keep both files within the
 * project's file-size cap.
 */
